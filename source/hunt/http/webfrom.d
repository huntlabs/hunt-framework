...
class WebForm
{
	...
	@property bool isVaild() const { return _vaild;}
	@property string[string] formMap() {return _forms;}
	@property FormFile[string] fileMap() {return _files;}
...
protected:
	...
	void readMultiFrom(string brand,SectionBuffer buffer){
		...
		if(! ((cast(string)sttr) == brony)) return;
		brony = "\r\n" ~ brony;
		bool run;
		do{
