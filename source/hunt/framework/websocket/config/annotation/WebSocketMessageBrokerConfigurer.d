 ...
 * @since 4.0
 */
abstract class WebSocketMessageBrokerConfigurer {
	 ...
	 * while the boolreturn value is used to determine if default message should
	 * be added as well.
	 ...
	 */
	bool configureMessageConverters(List!(MessageConverter) messageConverters) {
		return true;
	}
