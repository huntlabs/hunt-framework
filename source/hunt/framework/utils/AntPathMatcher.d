module hunt.framework.utils.AntPathMatcher;
...
class AntPathMatcher : PathMatcher {
    ...
    private void initialize() {
        ...
        stringMatcherCache = new HashMap!(string, string[])(256);
    }
	...
	protected string[] tokenizePattern(string pattern) {
		...
		bool cachePatterns = this.cachePatterns;
...
protected static class AntPathStringMatcher {
    ...
    private enum Pattern GLOB_PATTERN = Pattern.compile("\\?|\\*|\\{((?:\\{[^/]+?\\}|[^/{}]|\\\\[{}])+?)\\}");
