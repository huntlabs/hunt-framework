...
//     //     {
//     //         url = (_appConfig.https.enabled ? "https://" : "http://") ~ routeGroup.getValue() ~ url;
//     //     }
//     //     else
//     //     {
//     //         url = (routeGroup.getValue().length > 0 ? (_appConfig.application.baseUrl ~ routeGroup.getValue()) : strip(_appConfig.application.baseUrl, "", "/")) ~ url;
//     //     }
...
//     Route[] getAllRoutes() {
//         return _defaultGroup.getAllRoutes();
//     }
...
//         this.staticRootRoute = this.makeRoute("GET", "/", "staticDir:" ~ _appConfig.http.path, group);
//         // if (!haveRootRoute)
...
//             route.handle = getRouteHandler(handleKey);
//         }
//         else {
//             route.handle = mca;
//         }
...
//             version (HUNT_DEBUG)
//                 warningf("handle is null (%s).", route.getPattern());
//             return null;
//         }
...
//                     handleKey = "app.component." ~ route.getModule() ~ ".controller." ~ (
...
//         handleKey = handleKey.toLower();

//         version(HUNT_FM_DEBUG) {
//             tracef("handler: %s, route: path=%s, methods=%s, controller=%s", 
//                 handleKey, route.path, route.getMethods(), route.getController());
//         }
